...
printint(int fd, int xx, int base, int sgn)
{
 ...
 300:	8a 92 94 06 00 00    	mov    0x694(%edx),%dl
...
printf(int fd, const char *fmt, ...)
{
 ...
 4cb:	e9 c9 fe ff ff       	jmp    399 <printf+0x45>
          s = "(null)";
 4d0:	bb 8d 06 00 00       	mov    $0x68d,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 4f4:	a1 38 09 00 00       	mov    0x938,%eax
 ...
 506:	73 10                	jae    518 <free+0x30>
{
 ...
 52f:	89 08                	mov    %ecx,(%eax)
  freep = p;
 531:	a3 38 09 00 00       	mov    %eax,0x938
}
 536:	5b                   	pop    %ebx
 537:	5e                   	pop    %esi
 538:	5f                   	pop    %edi
 ...
 55c:	89 10                	mov    %edx,(%eax)
  freep = p;
 55e:	a3 38 09 00 00       	mov    %eax,0x938
}
 563:	5b                   	pop    %ebx
 564:	5e                   	pop    %esi
 565:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 57a:	46                   	inc    %esi
  if((prevp = freep) == 0){
 57b:	8b 3d 38 09 00 00    	mov    0x938,%edi
 ...
 5b5:	8b 3d 38 09 00 00    	mov    0x938,%edi
 ...
 60c:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 60f:	a3 38 09 00 00       	mov    %eax,0x938
      return (void*)(p + 1);
 ...
 62a:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 62c:	c7 05 38 09 00 00 3c 	movl   $0x93c,0x938
 633:	09 00 00 
 636:	c7 05 3c 09 00 00 3c 	movl   $0x93c,0x93c
 63d:	09 00 00 
    base.s.size = 0;
 640:	c7 05 40 09 00 00 00 	movl   $0x0,0x940
 647:	00 00 00 
 64a:	bf 3c 09 00 00       	mov    $0x93c,%edi
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
